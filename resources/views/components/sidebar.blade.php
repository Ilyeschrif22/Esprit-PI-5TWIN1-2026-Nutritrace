...
<div class="nutritrace-sidebar">
    ...
    <div class="sidebar-elements">
        <ul class="sidebar-list">
            <li class="dashboard" data-route="dashboard">
            ...
            <li class="products" data-route="products">
            ...
            <li class="batches" data-route="batches">
            ...
            <li class="utilisateurs" data-route="utilisateurs">
            ...
            <li class="traceability" data-route="traceability">
            ...
            <li class="transport" data-route="transport">
            ...
            <li class="certifications" data-route="certifications">
            ...
            <li class="documents" data-route="documents">
            ...
            <li class="env-impact" data-route="env-impact">
                <a href="{{ route('env-impact') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="lucide lucide-leaf">
                        <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" />
                        <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12" />
                    </svg>Impact envirenmental
                </a>
            </li>
 
            <li class="mapping" data-route="mapping">
            ...
            <li class="stats" data-route="stats">
                <a href="{{ route('stats') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Find the matching route and add active class
            if (currentRoute === '' || currentRoute === 'dashboard') {
                document.querySelector('.sidebar-list li.dashboard').classList.add('active');
            } else {
                const activeItem = document.querySelector(`.sidebar-list li[data-route="${currentRoute}"]`);
                if (activeItem) {
